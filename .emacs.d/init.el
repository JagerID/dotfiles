...
(custom-set-variables
 ...
 '(package-selected-packages
   '(cognitive-complexity vertico-multiform vertico-posframe apheleia avy cape colorful-mode corfu dirvish doom-modeline embark-consult ember-theme ember-twilight-theme evil flycheck-posframe kind-icon magit marginalia nerd-icons-completion nerd-icons-corfu orderless popup projectile pulsar rainbow-delimiters solo-jazz-theme svelte-mode treesit-auto vertico vterm web-mode))
 '(package-vc-selected-packages
   '((cognitive-complexity :vc-backend Git :url "https://github.com/emacs-vs/cognitive-complexity")
     (codemetrics :vc-backend Git :url "https://github.com/jcs-elpa/codemetrics"))))
